        ...
        <v-col cols="12" sm="8" md="6" lg="4">
          <v-card :dark="theme.dark">
            ...
            <v-card-actions class="justify-space-between">
              <v-btn :disabled="step === 0" depressed @click="prev" icon>
              ...
              <v-btn :disabled="step === steps - 1" depressed @click="next" icon>
...
export default {
  ...
  metaInfo() {
    return {
      ...
      meta: [
        { vmid: 'description', name: 'description', content: this.$t('profile.description') }
      ],
    }
  },
  setup(props, context) {
